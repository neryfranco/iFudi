    ...
    <body>
        ...
        <div id="wrapper">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Vendedor">
                        ...
                        <ul class="sidenav-second-level collapse" id="collapseMulti0">
                            <li>
                                <a href="lerVendedor2.jsp">Visualizar</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Avaliação">
                        ...
                        <ul class="sidenav-second-level collapse" id="collapseMulti1">
                            <li>
                                <a href="gravarAvaliacao.jsp">Gravar</a>
                            </li>
                            <li>
                                <a href="lerAvaliacao.jsp">Visualizar</a>
                            </li>
                            <li>
                                <a href="apagarAvaliacao.jsp">Apagar</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Pagamento">
                        <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseMulti9" data-parent="#exampleAccordion">
                            <i class="fa fa-fw fa-sitemap"></i>Pagamento
                        </a>
                        <ul class="sidenav-second-level collapse" id="collapseMulti9">
                            <li>
                                <a href="gravarPagamento.jsp">Gravar</a>
                            </li>
                            <li>
                                <a href="lerPagamento.jsp">Visualizar</a>
                            </li>
                            <li>
                                <a href="apagarPagamento.jsp">Apagar</a>
                            </li>
                        </ul>
                    </li>
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <h1>Bem Vindo</h1>
                    <p>Área destinada aos clientes do Sistema IFood.</p>
