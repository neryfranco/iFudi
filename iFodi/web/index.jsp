        ...
        <div class="row mbr-justify-content-center">
            ...
            <div class="col-lg-6 mbr-col-md-10">
                <div class="wrap">
                    ...
                    <div class="text-wrap vcenter">
                        <h2 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5">Cliente</h2>
                        <p class="mbr-fonts-style text1 mbr-text display-6">Para acessar área do cliente</p>
                        <a href="cliente.jsp">Acesse aqui</a>
                    </div>
                </div>
            </div>
        </div>
